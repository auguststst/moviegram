...
AliasMatch ^/manual(?:/(?:da|de|en|es|fr|ja|ko|pt-br|ru|tr|zh-cn))?(/.*)?$ "/tmp/pip-install-ec6f2x5t/mod-wsgi-httpd/build/httpd/manual$1"

<Directory "/tmp/pip-install-ec6f2x5t/mod-wsgi-httpd/build/httpd/manual">
    Options Indexes
    AllowOverride None
    Require all granted
